...
namespace SharedTestFixtures
{
    public class DatabaseTestBase : IDisposable
    {
        ...
        protected GivingPage CreateGivingPage(string pageName = null, int? fundId = null)
        {
            if(pageName == null)
            {
            ...
            {
                GivingPageId = RandomNumber(),
                PageName = pageName,
                PageTitle = RandomString(),
                PageType = RandomNumber(),
                FundId = (int)fundId,
                Enabled = true,
                DisabledReDirect = RandomString()
            };
        ...
        protected void DeleteGivingPage(GivingPage givingPage)
        {
            db.GivingPages.DeleteOnSubmit(givingPage);
            db.SubmitChanges();
        }

        protected GivingPageFund CreateGivingPageFund(int givingPageId, int fundId)
        {
            var givingPageFund = new GivingPageFund
            {
                GivingPageFundId = RandomNumber(),
        ...
        protected void DeleteGivingPageFund(GivingPageFund givingPageFund)
        {
            db.GivingPageFunds.DeleteOnSubmit(givingPageFund);
            db.SubmitChanges();
        }

        protected ContributionFund CreateContributionFund(string fundName = null)
        {
            if (fundName == null)
            {
        ...
        protected void DeleteContributionFund(ContributionFund contributionFund)
        {
            db.ContributionFunds.DeleteOnSubmit(contributionFund);
            db.SubmitChanges();
        }
