...
namespace CmsData
{
	[Table(Name="lookup.ContributionStatus")]
	public partial class ContributionStatus : INotifyPropertyChanging, INotifyPropertyChanged
	{
	...
	#region Foreign Keys
		...
		{
			this.SendPropertyChanging();
			entity.ContributionStatus = this;
		}
