...
namespace CmsData
{
    ...
    public partial class MemberTag : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        {
            get => this._CheckInCapacityDefault;
