...
namespace CmsData
{
    [Table(Name = "dbo.DuplicatesRun")]
    public partial class DuplicatesRun : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnFoundChanging(int? value);
        ...
        [Column(Name = "found", UpdateCheck = UpdateCheck.Never, Storage = "_Found", DbType = "int")]
        public int? Found
        {
            get => _Found;
            ...
            set
            {
                if (_Found != value)
                {
                    OnFoundChanging(value);
                    SendPropertyChanging();
                    _Found = value;
                    SendPropertyChanged("Found");
                    OnFoundChanged();
                }
            }
        }
