...
namespace CmsData
{
    ...
    public partial class Person : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<BackgroundCheck> _BackgroundCheckPeople;
        ...
        public Person()
        {
            ...
            _CheckInPendings = new EntitySet<CheckInPending>(new Action<CheckInPending>(attach_CheckInPendings), new Action<CheckInPending>(detach_CheckInPendings));
            ...
            _BackgroundCheckPeople = new EntitySet<BackgroundCheck>(new Action<BackgroundCheck>(attach_People), new Action<BackgroundCheck>(detach_People));
            ...
            _BaptismStatus = default;

            _BaptismType = default;

            _Campu = default;

            _DecisionType = default;

            _NewMemberClassStatus = default;
            ...
            _FamilyPosition = default;

            _Gender = default;

            _InterestPoint = default;

            _JoinType = default;

            _MaritalStatus = default;

            _MemberLetterStatus = default;

            _MemberStatus = default;

            _Origin = default;

            _Picture = default;

            _ResidentCode = default;

            _ContributionStatementOption = default;
        ...
        [Column(Name = "BarcodeId", UpdateCheck = UpdateCheck.Never, Storage = "_BarcodeId", DbType = "uniqueidentifier")]
        public Guid? BarcodeId
        {
            ...
            set
            {
                if (_BarcodeId != value)
                {
                    ...
                    SendPropertyChanging();
                    _BarcodeId = value;
                    SendPropertyChanged("BarcodeId");
                    OnBarcodeIdChanged();
                }
            }
        }

        [Column(Name = "BarcodeExpires", UpdateCheck = UpdateCheck.Never, Storage = "_BarcodeExpires", DbType = "datetime")]
        public DateTime? BarcodeExpires
        {
            get => _BarcodeExpires;
            set
            {
                if (_BarcodeExpires != value)
                {
                    OnBarcodeExpiresChanging(value);
                    SendPropertyChanging();
                    _BarcodeExpires = value;
                    SendPropertyChanged("BarcodeExpires");
                    OnBarcodeExpiresChanged();
                }
            }
        }
        ...
        {
            get => _CheckInPendings;
            set => _CheckInPendings.Assign(value);
        }
        ...
        [Association(Name = "FK_PaymentInfo_People", Storage = "_PaymentMethods", OtherKey = "PeopleId")]
        public EntitySet<PaymentMethod> PaymentMethods
        {
            get => _PaymentMethods;
            set => _PaymentMethods.Assign(value);
        }
        ...
        [Association(Name = "People__User", Storage = "_BackgroundCheckPeople", OtherKey = "UserID")]
        public EntitySet<BackgroundCheck> People
        {
            get => _BackgroundCheckPeople;
            set => _BackgroundCheckPeople.Assign(value);
        }
        ...
        public Organization BFClass
        {
            ...
            set
            {
                ...
                if (previousValue != value || _BFClass.HasLoadedOrAssignedValue == false)
                {
                    ...
                    {
                        _BibleFellowshipClassId = default;
                    }
        ...
        public NewMemberClassStatus NewMemberClassStatus
        {
            ...
            set
            {
                            ...
                            || (_NewMemberClassStatus.HasLoadedOrAssignedValue == false)))
                {
                    ...
                    {
                        _NewMemberClassStatusId = default;
                    }
        ...
        public EnvelopeOption ContributionStatementOption
        {
            ...
            set
            {
                            ...
                            || (_ContributionStatementOption.HasLoadedOrAssignedValue == false)))
                {
                    ...
                    {
                        _ContributionOptionsId = default;
                    }
