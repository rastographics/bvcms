...
namespace CmsData
{
    ...
    partial void OnCreated();
		...
		public Person()
		{
			...
			this._CheckInPendings = new EntitySet<CheckInPending>(new Action< CheckInPending>(this.attach_CheckInPendings), new Action< CheckInPending>(this.detach_CheckInPendings)); 
