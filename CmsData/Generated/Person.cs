...
namespace CmsData
{
    ...
    public partial class Person : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<CheckInPending> _CheckInPendings;
        ...
        partial void OnBarcodeIdChanging(Guid? value);
        partial void OnBarcodeIdChanged();

        partial void OnBarcodeExpiresChanging(DateTime? value);
        ...
        public Person()
        {
            this._contactsHad = new EntitySet<Contactee>(new Action<Contactee>(this.attach_contactsHad),
                new Action<Contactee>(this.detach_contactsHad));

            this._contactsMade = new EntitySet<Contactor>(new Action<Contactor>(this.attach_contactsMade),
                new Action<Contactor>(this.detach_contactsMade));

            this._EnrollmentTransactions = new EntitySet<EnrollmentTransaction>(
                new Action<EnrollmentTransaction>(this.attach_EnrollmentTransactions),
                new Action<EnrollmentTransaction>(this.detach_EnrollmentTransactions));

            this._FamiliesHeaded = new EntitySet<Family>(new Action<Family>(this.attach_FamiliesHeaded),
                new Action<Family>(this.detach_FamiliesHeaded));

            this._FamiliesHeaded2 = new EntitySet<Family>(new Action<Family>(this.attach_FamiliesHeaded2),
                new Action<Family>(this.detach_FamiliesHeaded2));

            this._OrgMemberDocuments = new EntitySet<OrgMemberDocument>(
                new Action<OrgMemberDocument>(this.attach_OrgMemberDocuments),
                new Action<OrgMemberDocument>(this.detach_OrgMemberDocuments));

            this._Attends = new EntitySet<Attend>(new Action<Attend>(this.attach_Attends),
                new Action<Attend>(this.detach_Attends));

            this._BackgroundChecks = new EntitySet<BackgroundCheck>(
                new Action<BackgroundCheck>(this.attach_BackgroundChecks),
                new Action<BackgroundCheck>(this.detach_BackgroundChecks));

            this._CardIdentifiers = new EntitySet<CardIdentifier>(
                new Action<CardIdentifier>(this.attach_CardIdentifiers),
                new Action<CardIdentifier>(this.detach_CardIdentifiers));

            this._CheckInPendings = new EntitySet<CheckInPending>(
                new Action<CheckInPending>(this.attach_CheckInPendings),
                new Action<CheckInPending>(this.detach_CheckInPendings));

            this._CheckInTimes = new EntitySet<CheckInTime>(new Action<CheckInTime>(this.attach_CheckInTimes),
                new Action<CheckInTime>(this.detach_CheckInTimes));

            this._Contributions = new EntitySet<Contribution>(new Action<Contribution>(this.attach_Contributions),
                new Action<Contribution>(this.detach_Contributions));

            this._Coupons = new EntitySet<Coupon>(new Action<Coupon>(this.attach_Coupons),
                new Action<Coupon>(this.detach_Coupons));

            this._EmailOptOuts = new EntitySet<EmailOptOut>(new Action<EmailOptOut>(this.attach_EmailOptOuts),
                new Action<EmailOptOut>(this.detach_EmailOptOuts));

            this._EmailQueues = new EntitySet<EmailQueue>(new Action<EmailQueue>(this.attach_EmailQueues),
                new Action<EmailQueue>(this.detach_EmailQueues));

            this._EmailQueueTos = new EntitySet<EmailQueueTo>(new Action<EmailQueueTo>(this.attach_EmailQueueTos),
                new Action<EmailQueueTo>(this.detach_EmailQueueTos));

            this._EmailResponses = new EntitySet<EmailResponse>(new Action<EmailResponse>(this.attach_EmailResponses),
                new Action<EmailResponse>(this.detach_EmailResponses));

            this._FK_Goers = new EntitySet<GoerSupporter>(new Action<GoerSupporter>(this.attach_FK_Goers),
                new Action<GoerSupporter>(this.detach_FK_Goers));

            this._ManagedGivings = new EntitySet<ManagedGiving>(new Action<ManagedGiving>(this.attach_ManagedGivings),
                new Action<ManagedGiving>(this.detach_ManagedGivings));

            this._MemberDocForms = new EntitySet<MemberDocForm>(new Action<MemberDocForm>(this.attach_MemberDocForms),
                new Action<MemberDocForm>(this.detach_MemberDocForms));

            this._MobileAppDevices = new EntitySet<MobileAppDevice>(
                new Action<MobileAppDevice>(this.attach_MobileAppDevices),
                new Action<MobileAppDevice>(this.detach_MobileAppDevices));

            this._MobileAppPushRegistrations = new EntitySet<MobileAppPushRegistration>(
                new Action<MobileAppPushRegistration>(this.attach_MobileAppPushRegistrations),
                new Action<MobileAppPushRegistration>(this.detach_MobileAppPushRegistrations));

            this._OrgMemberExtras = new EntitySet<OrgMemberExtra>(
                new Action<OrgMemberExtra>(this.attach_OrgMemberExtras),
                new Action<OrgMemberExtra>(this.detach_OrgMemberExtras));

            this._PaymentInfos = new EntitySet<PaymentInfo>(new Action<PaymentInfo>(this.attach_PaymentInfos),
                new Action<PaymentInfo>(this.detach_PaymentInfos));

            this._PeopleExtras = new EntitySet<PeopleExtra>(new Action<PeopleExtra>(this.attach_PeopleExtras),
                new Action<PeopleExtra>(this.detach_PeopleExtras));

            this._PrevOrgMemberExtras = new EntitySet<PrevOrgMemberExtra>(
                new Action<PrevOrgMemberExtra>(this.attach_PrevOrgMemberExtras),
                new Action<PrevOrgMemberExtra>(this.detach_PrevOrgMemberExtras));

            this._RecRegs = new EntitySet<RecReg>(new Action<RecReg>(this.attach_RecRegs),
                new Action<RecReg>(this.detach_RecRegs));

            this._RecurringAmounts = new EntitySet<RecurringAmount>(
                new Action<RecurringAmount>(this.attach_RecurringAmounts),
                new Action<RecurringAmount>(this.detach_RecurringAmounts));

            this._SmsGroupOptOuts = new EntitySet<SmsGroupOptOut>(
                new Action<SmsGroupOptOut>(this.attach_SmsGroupOptOuts),
                new Action<SmsGroupOptOut>(this.detach_SmsGroupOptOuts));

            this._SMSItems = new EntitySet<SMSItem>(new Action<SMSItem>(this.attach_SMSItems),
                new Action<SMSItem>(this.detach_SMSItems));

            this._SMSLists = new EntitySet<SMSList>(new Action<SMSList>(this.attach_SMSLists),
                new Action<SMSList>(this.detach_SMSLists));

            this._SmsReceiveds = new EntitySet<SmsReceived>(new Action<SmsReceived>(this.attach_SmsReceiveds),
                new Action<SmsReceived>(this.detach_SmsReceiveds));
            this._FK_Supporters = new EntitySet<GoerSupporter>(new Action<GoerSupporter>(this.attach_FK_Supporters),
                new Action<GoerSupporter>(this.detach_FK_Supporters));

            this._TagShares = new EntitySet<TagShare>(new Action<TagShare>(this.attach_TagShares),
                new Action<TagShare>(this.detach_TagShares));

            this._TaskListOwners = new EntitySet<TaskListOwner>(new Action<TaskListOwner>(this.attach_TaskListOwners),
                new Action<TaskListOwner>(this.detach_TaskListOwners));

            this._Transactions = new EntitySet<Transaction>(new Action<Transaction>(this.attach_Transactions),
                new Action<Transaction>(this.detach_Transactions));

            this._TransactionPeople = new EntitySet<TransactionPerson>(
                new Action<TransactionPerson>(this.attach_TransactionPeople),
                new Action<TransactionPerson>(this.detach_TransactionPeople));

            this._Users = new EntitySet<User>(new Action<User>(this.attach_Users), new Action<User>(this.detach_Users));

            this._VolInterestInterestCodes = new EntitySet<VolInterestInterestCode>(
                new Action<VolInterestInterestCode>(this.attach_VolInterestInterestCodes),
                new Action<VolInterestInterestCode>(this.detach_VolInterestInterestCodes));

            this._Volunteers = new EntitySet<Volunteer>(new Action<Volunteer>(this.attach_Volunteers),
                new Action<Volunteer>(this.detach_Volunteers));

            this._VolunteerForms = new EntitySet<VolunteerForm>(new Action<VolunteerForm>(this.attach_VolunteerForms),
                new Action<VolunteerForm>(this.detach_VolunteerForms));

            this._VoluteerApprovalIds = new EntitySet<VoluteerApprovalId>(
                new Action<VoluteerApprovalId>(this.attach_VoluteerApprovalIds),
                new Action<VoluteerApprovalId>(this.detach_VoluteerApprovalIds));

            this._GoerAmounts = new EntitySet<GoerSenderAmount>(new Action<GoerSenderAmount>(this.attach_GoerAmounts),
                new Action<GoerSenderAmount>(this.detach_GoerAmounts));

            this._OnBehalfOfPeople = new EntitySet<PeopleCanEmailFor>(
                new Action<PeopleCanEmailFor>(this.attach_OnBehalfOfPeople),
                new Action<PeopleCanEmailFor>(this.detach_OnBehalfOfPeople));

            this._OrganizationMembers = new EntitySet<OrganizationMember>(
                new Action<OrganizationMember>(this.attach_OrganizationMembers),
                new Action<OrganizationMember>(this.detach_OrganizationMembers));

            this._People = new EntitySet<BackgroundCheck>(new Action<BackgroundCheck>(this.attach_People),
                new Action<BackgroundCheck>(this.detach_People));

            this._PersonsCanEmail = new EntitySet<PeopleCanEmailFor>(
                new Action<PeopleCanEmailFor>(this.attach_PersonsCanEmail),
                new Action<PeopleCanEmailFor>(this.detach_PersonsCanEmail));

            this._SenderAmounts = new EntitySet<GoerSenderAmount>(
                new Action<GoerSenderAmount>(this.attach_SenderAmounts),
                new Action<GoerSenderAmount>(this.detach_SenderAmounts));

            this._SubRequests = new EntitySet<SubRequest>(new Action<SubRequest>(this.attach_SubRequests),
                new Action<SubRequest>(this.detach_SubRequests));

            this._SubResponses = new EntitySet<SubRequest>(new Action<SubRequest>(this.attach_SubResponses),
                new Action<SubRequest>(this.detach_SubResponses));

            this._Tags = new EntitySet<TagPerson>(new Action<TagPerson>(this.attach_Tags),
                new Action<TagPerson>(this.detach_Tags));

            this._TagsOwned = new EntitySet<Tag>(new Action<Tag>(this.attach_TagsOwned),
                new Action<Tag>(this.detach_TagsOwned));

            this._Tasks = new EntitySet<Task>(new Action<Task>(this.attach_Tasks), new Action<Task>(this.detach_Tasks));

            this._TasksAboutPerson = new EntitySet<Task>(new Action<Task>(this.attach_TasksAboutPerson),
                new Action<Task>(this.detach_TasksAboutPerson));

            this._TasksCoOwned = new EntitySet<Task>(new Action<Task>(this.attach_TasksCoOwned),
                new Action<Task>(this.detach_TasksCoOwned));

            this._VolRequests = new EntitySet<VolRequest>(new Action<VolRequest>(this.attach_VolRequests),
                new Action<VolRequest>(this.detach_VolRequests));

            this._VolResponses = new EntitySet<VolRequest>(new Action<VolRequest>(this.attach_VolResponses),
                new Action<VolRequest>(this.detach_VolResponses));
        ...
        [Column(Name = "PeopleId", UpdateCheck = UpdateCheck.Never, Storage = "_PeopleId", AutoSync = AutoSync.OnInsert,
        ...
        [Column(Name = "DoNotMailFlag", UpdateCheck = UpdateCheck.Never, Storage = "_DoNotMailFlag",
            DbType = "bit NOT NULL")]
        ...
        [Column(Name = "DoNotCallFlag", UpdateCheck = UpdateCheck.Never, Storage = "_DoNotCallFlag",
            DbType = "bit NOT NULL")]
        ...
        [Column(Name = "DoNotVisitFlag", UpdateCheck = UpdateCheck.Never, Storage = "_DoNotVisitFlag",
            DbType = "bit NOT NULL")]
        ...
        [Column(Name = "AddressTypeId", UpdateCheck = UpdateCheck.Never, Storage = "_AddressTypeId",
            DbType = "int NOT NULL")]
        ...
        [Column(Name = "PhonePrefId", UpdateCheck = UpdateCheck.Never, Storage = "_PhonePrefId",
            DbType = "int NOT NULL")]
        ...
        [Column(Name = "MaritalStatusId", UpdateCheck = UpdateCheck.Never, Storage = "_MaritalStatusId",
            DbType = "int NOT NULL")]
        [IsForeignKey]
        ...
        [Column(Name = "PositionInFamilyId", UpdateCheck = UpdateCheck.Never, Storage = "_PositionInFamilyId",
            DbType = "int NOT NULL")]
        [IsForeignKey]
        ...
        [Column(Name = "MemberStatusId", UpdateCheck = UpdateCheck.Never, Storage = "_MemberStatusId",
            DbType = "int NOT NULL")]
        [IsForeignKey]
        ...
        [Column(Name = "InterestPointId", UpdateCheck = UpdateCheck.Never, Storage = "_InterestPointId",
            DbType = "int")]
        [IsForeignKey]
        ...
        [Column(Name = "BaptismStatusId", UpdateCheck = UpdateCheck.Never, Storage = "_BaptismStatusId",
            DbType = "int")]
        [IsForeignKey]
        ...
        [Column(Name = "NewMemberClassStatusId", UpdateCheck = UpdateCheck.Never, Storage = "_NewMemberClassStatusId",
            DbType = "int")]
        [IsForeignKey]
        ...
        [Column(Name = "EnvelopeOptionsId", UpdateCheck = UpdateCheck.Never, Storage = "_EnvelopeOptionsId",
            DbType = "int")]
        [IsForeignKey]
        ...
        [Column(Name = "AddressFromDate", UpdateCheck = UpdateCheck.Never, Storage = "_AddressFromDate",
            DbType = "datetime")]
        ...
        [Column(Name = "AddressToDate", UpdateCheck = UpdateCheck.Never, Storage = "_AddressToDate",
            DbType = "datetime")]
        ...
        [Column(Name = "BaptismSchedDate", UpdateCheck = UpdateCheck.Never, Storage = "_BaptismSchedDate",
            DbType = "datetime")]
        ...
        [Column(Name = "LetterDateRequested", UpdateCheck = UpdateCheck.Never, Storage = "_LetterDateRequested",
            DbType = "datetime")]
        ...
        [Column(Name = "LetterDateReceived", UpdateCheck = UpdateCheck.Never, Storage = "_LetterDateReceived",
            DbType = "datetime")]
        ...
        [Column(Name = "LastName", UpdateCheck = UpdateCheck.Never, Storage = "_LastName",
        ...
        [Column(Name = "AddressLineOne", UpdateCheck = UpdateCheck.Never, Storage = "_AddressLineOne",
            DbType = "nvarchar(100)")]
        ...
        [Column(Name = "AddressLineTwo", UpdateCheck = UpdateCheck.Never, Storage = "_AddressLineTwo",
            DbType = "nvarchar(100)")]
        ...
        [Column(Name = "CountryName", UpdateCheck = UpdateCheck.Never, Storage = "_CountryName",
            DbType = "nvarchar(40)")]
        ...
        [Column(Name = "EmailAddress", UpdateCheck = UpdateCheck.Never, Storage = "_EmailAddress",
            DbType = "nvarchar(150)")]
        ...
        [Column(Name = "OtherPreviousChurch", UpdateCheck = UpdateCheck.Never, Storage = "_OtherPreviousChurch",
            DbType = "nvarchar(120)")]
        ...
        [Column(Name = "OtherNewChurch", UpdateCheck = UpdateCheck.Never, Storage = "_OtherNewChurch",
            DbType = "nvarchar(60)")]
        ...
        [Column(Name = "SchoolOther", UpdateCheck = UpdateCheck.Never, Storage = "_SchoolOther",
            DbType = "nvarchar(100)")]
        ...
        [Column(Name = "EmployerOther", UpdateCheck = UpdateCheck.Never, Storage = "_EmployerOther",
            DbType = "nvarchar(120)")]
        ...
        [Column(Name = "OccupationOther", UpdateCheck = UpdateCheck.Never, Storage = "_OccupationOther",
            DbType = "nvarchar(120)")]
        ...
        [Column(Name = "InterestOther", UpdateCheck = UpdateCheck.Never, Storage = "_InterestOther",
            DbType = "nvarchar(40)")]
        ...
        [Column(Name = "LetterStatusNotes", UpdateCheck = UpdateCheck.Never, Storage = "_LetterStatusNotes",
        ...
        [Column(Name = "ChristAsSavior", UpdateCheck = UpdateCheck.Never, Storage = "_ChristAsSavior",
            DbType = "bit NOT NULL")]
        ...
        [Column(Name = "MemberAnyChurch", UpdateCheck = UpdateCheck.Never, Storage = "_MemberAnyChurch",
            DbType = "bit")]
        ...
        [Column(Name = "InterestedInJoining", UpdateCheck = UpdateCheck.Never, Storage = "_InterestedInJoining",
            DbType = "bit NOT NULL")]
        ...
        [Column(Name = "PleaseVisit", UpdateCheck = UpdateCheck.Never, Storage = "_PleaseVisit",
            DbType = "bit NOT NULL")]
        ...
        [Column(Name = "InfoBecomeAChristian", UpdateCheck = UpdateCheck.Never, Storage = "_InfoBecomeAChristian",
            DbType = "bit NOT NULL")]
        ...
        [Column(Name = "ContributionsStatement", UpdateCheck = UpdateCheck.Never, Storage = "_ContributionsStatement",
            DbType = "bit NOT NULL")]
        ...
        [Column(Name = "ContributionOptionsId", UpdateCheck = UpdateCheck.Never, Storage = "_ContributionOptionsId",
            DbType = "int")]
        [IsForeignKey]
        ...
        [Column(Name = "PrimaryCity", UpdateCheck = UpdateCheck.Never, Storage = "_PrimaryCity",
            DbType = "nvarchar(30)")]
        ...
        [Column(Name = "PrimaryAddress", UpdateCheck = UpdateCheck.Never, Storage = "_PrimaryAddress",
            DbType = "nvarchar(100)")]
        ...
        [Column(Name = "PrimaryState", UpdateCheck = UpdateCheck.Never, Storage = "_PrimaryState",
            DbType = "nvarchar(20)")]
        ...
        [Column(Name = "PrimaryAddress2", UpdateCheck = UpdateCheck.Never, Storage = "_PrimaryAddress2",
            DbType = "nvarchar(100)")]
        ...
        [Column(Name = "PrimaryBadAddrFlag", UpdateCheck = UpdateCheck.Never, Storage = "_PrimaryBadAddrFlag",
            DbType = "int")]
        ...
        [Column(Name = "BibleFellowshipClassId", UpdateCheck = UpdateCheck.Never, Storage = "_BibleFellowshipClassId",
            DbType = "int")]
        [IsForeignKey]
        ...
        [Column(Name = "CheckInNotes", UpdateCheck = UpdateCheck.Never, Storage = "_CheckInNotes",
        ...
        [Column(Name = "BDate", UpdateCheck = UpdateCheck.Never, Storage = "_BDate", DbType = "datetime",
            IsDbGenerated = true)]
        ...
        [Column(Name = "EmailAddress2", UpdateCheck = UpdateCheck.Never, Storage = "_EmailAddress2",
            DbType = "nvarchar(60)")]
        ...
        [Column(Name = "SendEmailAddress1", UpdateCheck = UpdateCheck.Never, Storage = "_SendEmailAddress1",
            DbType = "bit")]
        ...
        [Column(Name = "SendEmailAddress2", UpdateCheck = UpdateCheck.Never, Storage = "_SendEmailAddress2",
            DbType = "bit")]
        ...
        [Column(Name = "NewMemberClassDate", UpdateCheck = UpdateCheck.Never, Storage = "_NewMemberClassDate",
            DbType = "datetime")]
        ...
        [Column(Name = "PrimaryCountry", UpdateCheck = UpdateCheck.Never, Storage = "_PrimaryCountry",
            DbType = "nvarchar(40)")]
        ...
        [Column(Name = "DoNotPublishPhones", UpdateCheck = UpdateCheck.Never, Storage = "_DoNotPublishPhones",
            DbType = "bit")]
        ...
        [Column(Name = "IsDeceased", UpdateCheck = UpdateCheck.Never, Storage = "_IsDeceased", DbType = "bit",
            IsDbGenerated = true)]
        ...
        [Column(Name = "HashNum", UpdateCheck = UpdateCheck.Never, Storage = "_HashNum", DbType = "int",
            IsDbGenerated = true)]
        public int? HashNum
        {
        ...
        [Column(Name = "PreferredName", UpdateCheck = UpdateCheck.Never, Storage = "_PreferredName",
            DbType = "nvarchar(25)", IsDbGenerated = true)]
        ...
        [Column(Name = "Name2", UpdateCheck = UpdateCheck.Never, Storage = "_Name2", DbType = "nvarchar(139)",
            IsDbGenerated = true)]
        public string Name2
        {
        ...
        [Column(Name = "Name", UpdateCheck = UpdateCheck.Never, Storage = "_Name", DbType = "nvarchar(138)",
            IsDbGenerated = true)]
        public string Name
        {
        ...
        [Column(Name = "ElectronicStatement", UpdateCheck = UpdateCheck.Never, Storage = "_ElectronicStatement",
            DbType = "bit")]
        ...
        [Column(Name = "BarcodeId", UpdateCheck = UpdateCheck.Never, Storage = "_BarcodeId",
            DbType = "uniqueidentifier")]
        public Guid? BarcodeId
        {
            get { return this._BarcodeId; }
        ...
        [Column(Name = "BarcodeExpires", UpdateCheck = UpdateCheck.Never, Storage = "_BarcodeExpires",
            DbType = "datetime")]
        public DateTime? BarcodeExpires
        {
            get { return this._BarcodeExpires; }

            set
            {
                if (this._BarcodeExpires != value)
                {
                    this.OnBarcodeExpiresChanging(value);
                    this.SendPropertyChanging();
                    this._BarcodeExpires = value;
                    this.SendPropertyChanged("BarcodeExpires");
                    this.OnBarcodeExpiresChanged();
                }
            }
        }
        ...
        [Association(Name = "ENROLLMENT_TRANSACTION_PPL_FK", Storage = "_EnrollmentTransactions",
            OtherKey = "PeopleId")]
        ...
        [Association(Name = "FamiliesHeaded__HeadOfHousehold", Storage = "_FamiliesHeaded",
            OtherKey = "HeadOfHouseholdId")]
        ...
        [Association(Name = "FamiliesHeaded2__HeadOfHouseholdSpouse", Storage = "_FamiliesHeaded2",
            OtherKey = "HeadOfHouseholdSpouseId")]
        ...
        [Association(Name = "FK__OrgMember__Peopl__1C330188", Storage = "_OrgMemberDocuments", OtherKey = "PeopleId")]
        ...
        [Association(Name = "FK_CheckInPending_People", Storage = "_CheckInPendings", OtherKey = "PeopleId")]
        public EntitySet<CheckInPending> CheckInPendings
        {
            get { return this._CheckInPendings; }

            set { this._CheckInPendings.Assign(value); }
        }
        ...
        [Association(Name = "FK_MobileAppPushRegistrations_People", Storage = "_MobileAppPushRegistrations",
            OtherKey = "PeopleId")]
        ...
        [Association(Name = "FK_VolInterestInterestCodes_People", Storage = "_VolInterestInterestCodes",
            OtherKey = "PeopleId")]
        ...
        [Association(Name = "BFMembers__BFClass", Storage = "_BFClass", ThisKey = "BibleFellowshipClassId",
            IsForeignKey = true)]
        ...
        [Association(Name = "EnvPeople__EnvelopeOption", Storage = "_EnvelopeOption", ThisKey = "EnvelopeOptionsId",
            IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_BaptismStatus", Storage = "_BaptismStatus", ThisKey = "BaptismStatusId",
            IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_BaptismType", Storage = "_BaptismType", ThisKey = "BaptismTypeId",
            IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_DecisionType", Storage = "_DecisionType", ThisKey = "DecisionTypeId",
            IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_DiscoveryClassStatus", Storage = "_NewMemberClassStatus",
            ThisKey = "NewMemberClassStatusId", IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_EntryPoint", Storage = "_EntryPoint", ThisKey = "EntryPointId",
            IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_FamilyPosition", Storage = "_FamilyPosition", ThisKey = "PositionInFamilyId",
            IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_InterestPoint", Storage = "_InterestPoint", ThisKey = "InterestPointId",
            IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_MaritalStatus", Storage = "_MaritalStatus", ThisKey = "MaritalStatusId",
            IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_MemberLetterStatus", Storage = "_MemberLetterStatus", ThisKey = "LetterStatusId",
            IsForeignKey = true)]
        ...
        [Association(Name = "FK_People_MemberStatus", Storage = "_MemberStatus", ThisKey = "MemberStatusId",
            IsForeignKey = true)]
        ...
        [Association(Name = "ResCodePeople__ResidentCode", Storage = "_ResidentCode", ThisKey = "ResCodeId",
            IsForeignKey = true)]
        ...
        [Association(Name = "StmtPeople__ContributionStatementOption", Storage = "_ContributionStatementOption",
            ThisKey = "ContributionOptionsId", IsForeignKey = true)]
        ...
        private void attach_CheckInPendings(CheckInPending entity)
        {
            this.SendPropertyChanging();
            entity.Person = this;
        }

        private void detach_CheckInPendings(CheckInPending entity)
        {
            this.SendPropertyChanging();
            entity.Person = null;
        }
