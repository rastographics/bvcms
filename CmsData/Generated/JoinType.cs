...
namespace CmsData
{
	[Table(Name="lookup.JoinType")]
	public partial class JoinType : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    #region Foreign Key Tables
   		...
   		[Association(Name="FK_People_JoinType", Storage="_People", OtherKey="JoinCodeId")]
	...
	#region Foreign Keys
		...
		{
			this.SendPropertyChanging();
			entity.JoinType = this;
		}

		private void detach_People(Person entity)
		{
			this.SendPropertyChanging();
			entity.JoinType = null;
		}
