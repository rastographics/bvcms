...
{
	[Table(Name="OrgFilterPrevious")]
	public partial class OrgFilterPreviou
	{
		...
		[Column(Name="Tab", Storage="_Tab", DbType="varchar(8) NOT NULL")]
		public string Tab
		{
			get
			{
		...
		[Column(Name="Dropped", Storage="_Dropped", DbType="datetime NOT NULL")]
		...
		[Column(Name="Hidden", Storage="_Hidden", DbType="int NOT NULL")]
		public int Hidden
		{
			get
			{
