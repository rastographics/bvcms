...
namespace CmsData
{
    ...
    public partial class MeetingType : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [Column(Name = "Code", UpdateCheck = UpdateCheck.Never, Storage = "_Code", DbType = "char(1)")]
        public string Code
        {
            get => _Code;
        ...
        [Column(Name = "Description", UpdateCheck = UpdateCheck.Never, Storage = "_Description", DbType = "nvarchar(10)")]
