...
namespace CmsData
{
    ...
    partial void OnCreated();
		...
		partial void OnInvertChanging(bool value);
		partial void OnInvertChanged();
		
		partial void OnOrderChanging(int value);
		partial void OnOrderChanged();
		
		partial void OnOrgEVChanging(string value);
		partial void OnOrgEVChanged();
		
		partial void OnPersonFlagChanging(string value);
		partial void OnPersonFlagChanged();
    ...
    #region Columns
		...
		[Column(Name="width", UpdateCheck=UpdateCheck.Never, Storage="_Width", DbType="decimal NOT NULL")]
		...
		[Column(Name="height", UpdateCheck=UpdateCheck.Never, Storage="_Height", DbType="decimal NOT NULL")]
		...
		[Column(Name="invert", UpdateCheck=UpdateCheck.Never, Storage="_Invert", DbType="bit NOT NULL")]
		public bool Invert
		{
			...
			set
			{
				if (this._Invert != value)
				{
                    ...
                    this.OnInvertChanging(value);
					this.SendPropertyChanging();
					this._Invert = value;
					this.SendPropertyChanged("Invert");
					this.OnInvertChanged();
				}
		...
		[Column(Name="orgEV", UpdateCheck=UpdateCheck.Never, Storage="_OrgEV", DbType="nvarchar(50)")]
		public string OrgEV
		{
			get { return this._OrgEV; }

			set
			{
				if (this._OrgEV != value)
				{
				
                    this.OnOrgEVChanging(value);
					this.SendPropertyChanging();
					this._OrgEV = value;
					this.SendPropertyChanged("OrgEV");
					this.OnOrgEVChanged();
				}
		...
		[Column(Name="personFlag", UpdateCheck=UpdateCheck.Never, Storage="_PersonFlag", DbType="nvarchar(10)")]
		public string PersonFlag
		{
			get { return this._PersonFlag; }

			set
			{
				if (this._PersonFlag != value)
				{
				
                    this.OnPersonFlagChanging(value);
					this.SendPropertyChanging();
					this._PersonFlag = value;
					this.SendPropertyChanged("PersonFlag");
					this.OnPersonFlagChanged();
				}
