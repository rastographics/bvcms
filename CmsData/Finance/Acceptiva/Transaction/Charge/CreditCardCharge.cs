...
namespace CmsData.Finance.Acceptiva.Transaction.Charge
{
    internal class CreditCardCharge : ChargeRequest
    {
        ...
        public CreditCardCharge(bool isTesting, string apiKey, string ipAddress, string cc_id, CreditCard creditCard,
            Payer payer, decimal amt, string tranId, string tranDesc)
            :base(isTesting, apiKey, ipAddress, cc_id, paymentTypeCC, amt, tranId, tranDesc, payer)
        {
