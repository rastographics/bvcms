...
{
    internal class CreditCardVaultSaleRequest : TransactionProcessingRequest
    {
        ...
        public CreditCardVaultSaleRequest(string id, string key, Guid vaultGuid, string nameOnCard, BillingAddress billingAddress, decimal amount, string orderNumber)
            : this(id, key, vaultGuid, nameOnCard, billingAddress, amount)
        {
            Data["T_ORDERNUM"] = orderNumber;
        }

        public CreditCardVaultSaleRequest(string id, string key, Guid vaultGuid, string nameOnCard, BillingAddress billingAddress, decimal amount, string orderNumber, string customerNumber)
