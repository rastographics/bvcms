...
SELECT 
	...
	,ShowDOBOnFind = CAST(IIF(RegSettingXml.value('(//ShowDOBOnFind)[1]', 'varchar(10)') IS NOT NULL, 1, NULL) AS BIT)
	,ShowPhoneOnFind = CAST(IIF(RegSettingXml.value('(//ShowPhoneOnFind)[1]', 'varchar(10)') IS NOT NULL, 1, NULL) AS BIT)
