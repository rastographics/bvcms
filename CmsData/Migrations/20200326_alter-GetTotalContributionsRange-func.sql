ALTER FUNCTION [dbo].[GetTotalContributionsRange]
(
	@fd DATETIME, 
	@td DATETIME,
	@campusid INT,
...
(
	WITH contributions AS (
		...
		FROM dbo.ContributionSearch(NULL, NULL, NULL, NULL, @fd, @td, @campusid, 0, 2, 0, 
				CASE WHEN ISNULL(@nontaxded, 0) = 1 THEN 'both' ELSE 'taxded' END,
				NULL, 0, NULL, @includeUnclosed, NULL, NULL, NULL, @fundids, @includePledges) cs
