/****** Object:  StoredProcedure [dbo].[PurgePerson]    Script Date: 8/2/2018 9:27:56 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[PurgePerson](@pid INT)
AS
BEGIN
	BEGIN TRY
	  IF(@pid > 1)
	  BEGIN
		...
		DELETE dbo.BackgroundChecks WHERE PeopleId = @pid
