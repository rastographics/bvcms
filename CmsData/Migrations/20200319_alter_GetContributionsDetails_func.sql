...
from dbo.ContributionSearch(null, null, null, null, @fd, @td, @campusid, null, @online, -1,
	case @nontaxded
		when 1 then 'NonTaxDed' 
		when 0 then 'TaxDed' 
		else IIF(@pledges = 1, '', 'Both') END,
	null, null, null, @includeUnclosed, null, null, @tagid, @fundids, @pledges
	) cs
