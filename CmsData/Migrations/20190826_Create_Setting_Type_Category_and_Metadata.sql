...
('GoogleGeocodeAPIKey', 'Copy the value from the key named <i>touchpoint-gmap</i> and paste it here. See <a href="https://docs.touchpointsoftware.com/Organizations/SmallGroupFinderMap.html" target="_blank">Small Group Finder - Embedding a Map</a>.', @dataText, @SmallGroupFinder),
('GoogleMapsAPIKey', 'Copy the value from the key named <i>touchpoint-geocode</i>. See <a href="https://docs.touchpointsoftware.com/Organizations/SmallGroupFinderMap.html" target="_blank">Small Group Finder - Embedding a Map</a>.', @dataText, @SmallGroupFinder),
...
('AdminCoupon', 'You can change the Setting value and use this as a coupon when testing online registrations.', @dataText, @Administration),
