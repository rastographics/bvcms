...
('DefaultFundId', 'Use this Setting if you want a fund other than Fund ID <i>1</i> to be the default fund. When creating a new Bundle, this is the fund that always appears at the top of the list of funds when setting the default for the bundle.', 3, 2, 3),
