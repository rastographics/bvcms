...
namespace CmsData
{
    public partial class QueryBuilderClause2
    {
        ...
        private static QueryBuilderClause2 ImportClause(XElement r, QueryBuilderClause2 parent)
        {
            ...
            if (c.Field == "Group")
            {
                c.Clauses = new List<QueryBuilderClause2>();
                foreach (var rr in r.Elements())
                    c.Clauses.Add(ImportClause(rr, c));
            }
            return c;
        }
