...
namespace CmsData
{
    public partial class QueryBuilderClause2
    {
        ...
        public List<QueryBuilderClause2> Clauses { get; set; }
		public QueryBuilderClause2 Parent { get; set; }
...
//        public QueryBuilderClause2 Clone(CMSDataContext Db)
//        {
//            var q = new QueryBuilderClause2();
//            q.CopyFrom(this);
...
//        public void CopyFromAll(QueryBuilderClause2 from, CMSDataContext Db)
//        {
//            foreach (var c in Clauses)
//                DeleteClause(c, Db);
//            CopyFrom(from);
...
//        }
//        private void DeleteClause(QueryBuilderClause2 qb, CMSDataContext Db)
//        {
...
//            return nc.QueryId;
//        }
        public static QueryBuilderClause2 NewGroupClause()
        {
            var qb = new QueryBuilderClause2();
            qb.SetQueryType(QueryType.Group);
            qb.SetComparisonType(CompareType.AllTrue);
            return qb;
        }
        public QueryBuilderClause2 AddNewGroupClause(CompareType op)
        {
            var qb = new QueryBuilderClause2();
            qb.SetQueryType(QueryType.Group);
            this.Clauses.Add(qb);
