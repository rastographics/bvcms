$(function () {
    ...
    $('#editor-modal').on('shown.bs.modal', function () {
        ...
        $('#htmleditor').froalaEditable({
            ...
            height: 200,
            theme: 'custom',
            buttons: ['bold', 'italic', 'underline', 'fontSize', 'fontFamily', 'color', 'sep', 'formatBlock', 'align', 'insertOrderedList', 'insertUnorderedList', 'outdent', 'indent', 'sep', 'createLink', 'specialLink', 'sep', 'insertImage', 'uploadFile', 'table', 'undo', 'redo', 'removeFormat', 'html', 'fullscreen'],
