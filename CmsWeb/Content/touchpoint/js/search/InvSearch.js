$(function () {
    ...
    $("#clear").click(function (ev) {
        ...
        $("#OnlineReg").val(-1);
        $.post('/InvSearch/DivisionIds/0', null, function (ret) {
            $('#DivisionId').html(ret);
        });
        $.getTable();
    ...
    $("#search").click(function (ev) {
        ...
        if (name.startsWith("M.")) {
            ...
            f.attr("action", "/InvSearch/CreateMeeting/" + name);
            f.submit();
        }
        $.getTable();
        return false;
    ...
    $.descredit = function ($a) {
        ...
        $("#save-edit").off("click").on("click", function (ev) {
            ...
            $a.html(v);
            var id = $a.attr("id");
            $.post("/InvSearch/SetDescription", { id: id, description: v });
    ...
    $('#ProgramId').change(function () {
        $.post('/InvSearch/DivisionIds/' + $(this).val(), null, function (ret) {
            $('#DivisionId').html(ret);
        });
    });
    ...
    $("#ApplyType").click(function (ev) {
        ...
        swal({
            ...
            function () {
                $.block();
                $.post('/InvSearch/ApplyType/' + $("#TargetType").val(), q, function (ret) {
                    $.unblock();
                    if (ret !== "") {
                        if (ret === "ok")
                            $.getTable();
    ...
    $("#MakeChildrenOf").click(function (ev) {
        ...
        swal({
            ...
            function () {
                $.block();
                $.post('/InvSearch/MakeChildrenOf/' + $("#ParentOrg").val(), q, function (ret) {
                    $.unblock();
                    if (ret !== "") {
                        if (ret === "ok")
                            $.getTable();
    ...
    $("#MakeNewDiv").click(function (ev) {
        ev.preventDefault();
        $.post('/InvSearch/MakeNewDiv/', { id: $("#NewDivProgramId").val(), name: $("#NewDiv").val() }, function (ret) {
            $('#TagDiv').html(ret);
            $("#NewDiv").val("");
    ...
    $("#RenameDiv").click(function (ev) {
        ev.preventDefault();
        $.post('/InvSearch/RenameDiv/', { id: $("#TagProgramId").val(), divid: $("#TagDiv").val(), name: $("#RenamedDiv").val() }, function (ret) {
            if (ret == "error") {
    ...
    $("#TagProgramId").change(function () {
        $.post('/InvSearch/TagDivIds/' + $(this).val(), null, function (ret) {
            $('#TagDiv').html(ret);
            $("#search").click();
        });
    });
    ...
    $('#ViewAttNotices').click(function (ev) {
        ev.preventDefault();
        $("#orgsearchform").attr("action", "/InvSearch/DisplayAttendanceNotices");
        $.block();
    ...
    $('#AttNotices').click(function (ev) {
        ...
        swal({
            ...
            function () {
                ...
                $.post("/InvSearch/EmailAttendanceNotices", q, function () {
                    $.unblock();
                    swal({
                        title: "Complete!",
    ...
    $('#rollsheet1').click(function (ev) {
        ...
        $.post('/InvSearch/DefaultMeetingDate/' + scheduleId, null, function (ret) {
    ...
    $('#newmeetings').click(function (ev) {
        ev.preventDefault();
        $.post('/InvSearch/DefaultMeetingDate/' + $('#ScheduleId').val(), null, function (ret) {
    ...
    $('#createmeetings').click(function (ev) {
        ...
        var q = $("#orgsearchform").serialize();
        $.post("/InvSearch/CreateMeetings" + args, q, function () {
    ...
    $('#ExportExcel').click(function (ev) {
        ev.preventDefault();
        $("#orgsearchform").attr("action", "/InvSearch/ExportExcel");
        $("#orgsearchform").submit();
        return true;
    });
    ...
    $('#pendingtomember').click(function (ev) {
        ...
        swal({
            ...
            function () {
                $.block();
                $.post("/InvSearch/MovePendingToMember", q, function (ret) {
                    $.unblock();
                    swal({
                        title: "Completed!",
                        text: ret,
    ...
    $('#ExportMembersExcel').click(function (ev) {
        ev.preventDefault();
        $("#orgsearchform").attr("action", "/InvSearch/ExportMembersExcel");
        $("#orgsearchform").submit();
        return true;
    });
    ...
    $('#Structure').click(function (ev) {
        ev.preventDefault();
        $("#orgsearchform").attr("action", "/InvSearch/OrganizationStructure");
        $("#orgsearchform").submit();
        return true;
    });
    ...
    $('#PasteSettings').click(function (ev) {
        ...
        var href = this.href;
        var q = $("#orgsearchform").serialize();
        $.post("/InvSearch/Count", q, function (cnt) {
            swal({
                title: "Are you sure?",
    ...
    $('#ExportMessages').click(function (ev) {
        ...
        $("#orgsearchform").attr("action", "/InvSearch/RegMessages?" + args);
        $("#orgsearchform").submit();
    });
