...
function animateColors() {
    $(".top").velocity({ fill: "#eaab00" }, 250, function () {
        $(".right").velocity({ fill: "#eaab00" }, 250, function () {
            $(".bottom").velocity({ fill: "#eaab00" }, 250, function () {
                $(".left").velocity({ fill: "#eaab00" }, 250, function () {
                    animateColors();
