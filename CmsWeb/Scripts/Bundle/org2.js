...
///#source 1 1 /Scripts/Org/Organization2.js
onload = function () {
    ...
    $('#NewMeeting').live("click", function (ev) {
        ...
        d.dialog("option", "buttons", {
            "Ok": function () {
                ...
                $.post("/Org/NewMeeting", { d: dt.date, t: dt.time, AttendCredit: $("#AttendCreditList").val(), group: $('#group').is(":checked") }, function (ret) {
                    if (!ret.startsWith("error"))
                        window.location = ret;
                });
                $(this).dialog("close");
...
///#source 1 1 /Scripts/js/RegSetting2.js
$(function () {
