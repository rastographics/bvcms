...
namespace CmsWeb.Areas.Search.Models
{
	public class QuickSearchModel
	{
		...
		private IEnumerable<CmsWeb.Models.OrgSearchModel.OrganizationInfo> Orglist()
		{
			...
			if (text1.AllDigits())
				...
				qo = from o in qo
					 ...
					 orderby o.Division.Program.Name, o.Division.Name, o.OrganizationName
					 select o;
			return CmsWeb.Models.OrgSearchModel.OrganizationList(qo.Take(CountMax), null, null);
		}
