...
namespace CmsWeb.Areas.Finance.Models.BatchImport
{
    internal class BatchImportContributions
    {
        ...
        private static IContributionBatchImporter FindMatchingImporter(string text, bool fromFile)
        {
            ...
            if (subtext.Contains("date,time,time_zone,transaction_id,transfer_id,transfer_date,transfer_net,first_name,last_name,email,give_amount,net_amount,fee_amount,status,member_id,campus_id,fund,fund_id,cause,cause_id,refund_amount"))
