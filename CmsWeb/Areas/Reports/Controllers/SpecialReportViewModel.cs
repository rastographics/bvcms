...
namespace CmsWeb.Areas.Reports.Controllers
{
    public class SpecialReportViewModel
    {
        ...
        public void RunSqlReport()
        {
            ...
            CurrentDatabase.LogActivity($"Run SQL report: {Report}", pid: Util.UserPeopleId, uid: CurrentDatabase.UserId);
        }
        ...
        public void RunPyScript()
        {
            ...
            CurrentDatabase.LogActivity($"Run Python script: {Report}", pid: Util.UserPeopleId, uid: CurrentDatabase.UserId);
        }
