...
namespace CmsWeb.Areas.Main.Models.Directories
{
    ...
    {
        private readonly IEnumerable<CompactFamilyInfo> q;
        public CompactDir(Guid qid)
        {
            ...
            q = from p in tag.People(DbUtil.Db)
                ...
                select new CompactFamilyInfo()
                {
                    ...
                    head = new PersonInfo
                    {
                        First = family.HeadOfHousehold.PreferredName,
                    ...
                    {
                        First = family.HeadOfHouseholdSpouse.PreferredName,
                    ...
                    children = from m in family.People
                               ...
                               where m.PeopleId != family.HeadOfHouseholdId
                               where m.PeopleId != (family.HeadOfHouseholdSpouseId ?? 0)
                               orderby m.Age ?? 200 descending
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            charactersWithSpaces1.Text = "265";
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00E7001C" };
            Rsid rsid1 = new Rsid() { Val = "000249F1" };
            Rsid rsid2 = new Rsid() { Val = "005205ED" };
            Rsid rsid3 = new Rsid() { Val = "005F5A99" };
            Rsid rsid4 = new Rsid() { Val = "006324FB" };
            Rsid rsid5 = new Rsid() { Val = "00A01149" };
            Rsid rsid6 = new Rsid() { Val = "00A01D25" };
            Rsid rsid7 = new Rsid() { Val = "00B14EF8" };
            Rsid rsid8 = new Rsid() { Val = "00C74C6E" };
            Rsid rsid9 = new Rsid() { Val = "00E7001C" };
        ...
        private void GenerateStylesWithEffectsPart1Content(StylesWithEffectsPart stylesWithEffectsPart1)
        {
            ...
            RunFonts runFonts36 = new RunFonts() { AsciiTheme = ThemeFontValues.MinorHighAnsi, HighAnsiTheme = ThemeFontValues.MinorHighAnsi, EastAsiaTheme = ThemeFontValues.MinorHighAnsi, ComplexScriptTheme = ThemeFontValues.MinorBidi };
            ...
            runPropertiesBaseStyle1.Append(runFonts36);
            runPropertiesBaseStyle1.Append(fontSize35);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript35);
            ...
            SpacingBetweenLines spacingBetweenLines8 = new SpacingBetweenLines() { After = "200", Line = "276", LineRule = LineSpacingRuleValues.Auto };

            paragraphPropertiesBaseStyle1.Append(spacingBetweenLines8);
            ...
            Rsid rsid10 = new Rsid() { Val = "00E7001C" };
            ...
            styleRunProperties1.Append(underline4);
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            RunFonts runFonts37 = new RunFonts() { AsciiTheme = ThemeFontValues.MinorHighAnsi, HighAnsiTheme = ThemeFontValues.MinorHighAnsi, EastAsiaTheme = ThemeFontValues.MinorHighAnsi, ComplexScriptTheme = ThemeFontValues.MinorBidi };
            ...
            runPropertiesBaseStyle2.Append(runFonts37);
            runPropertiesBaseStyle2.Append(fontSize36);
            runPropertiesBaseStyle2.Append(fontSizeComplexScript36);
            ...
            SpacingBetweenLines spacingBetweenLines9 = new SpacingBetweenLines() { After = "200", Line = "276", LineRule = LineSpacingRuleValues.Auto };

            paragraphPropertiesBaseStyle2.Append(spacingBetweenLines9);
            ...
            Style style10 = new Style() { Type = StyleValues.Character, StyleId = "Hyperlink" };
            ...
            Rsid rsid11 = new Rsid() { Val = "00E7001C" };

            StyleRunProperties styleRunProperties2 = new StyleRunProperties();
            Color color2 = new Color() { Val = "0000FF", ThemeColor = ThemeColorValues.Hyperlink };
            Underline underline5 = new Underline() { Val = UnderlineValues.Single };

            styleRunProperties2.Append(color2);
            styleRunProperties2.Append(underline5);
