...
{
    public class InvolvementModel : InvolvementPeopleModel
    {
        ...
        public InvolvementModel(CMSDataContext db) : base(db)
        {
            CurrentDatabase = db;
        }

        public int InvolvementId
        {
            set
            {
        ...
        */
        ...
        public static InvolvementModel Create(CMSDataContext db, IPrincipal user)
        {
            return new InvolvementModel(db);
        }
    }
}
