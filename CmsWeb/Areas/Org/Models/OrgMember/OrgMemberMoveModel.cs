...
{
    public class OrgMemberMoveModel : PagedTableModel<CmsData.Organization, OrgMoveInfo>
    {
        private int? orgId;
        ...
        public override IQueryable<CmsData.Organization> DefineModelList()
        {
        ...
        public override IQueryable<CmsData.Organization> DefineModelSort(IQueryable<CmsData.Organization> q)
        {
            return q.OrderBy(m => m.OrganizationName);
        }

        public override IEnumerable<OrgMoveInfo> DefineViewList(IQueryable<CmsData.Organization> q)
        {
            return from o in q
