...
namespace CmsWeb.Areas.Main.Models.Directories
{
	public class FamilyDir : ActionResult
	{
		...
		public FamilyDir(object qid)
		{
    			...
    			q = from p in tag.People(DbUtil.Db)
                         ...
                         select new FamilyInfo()
                         {
                             ...
                             Members = from m in family.People
                                       where !m.DeceasedDate.HasValue
									   orderby m.PositionInFamilyId + (m.PeopleId == family.HeadOfHouseholdId ? -1 : 0), 
												(m.Age ?? 200) descending
                                       select new PersonInfo()
                                       {
										   First = m.PreferredName,
										   Last = m.LastName,
										   Age = m.Age,
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            template1.Text = "FamilyMergeDoc (2).dotx";
            ...
            charactersWithSpaces1.Text = "235";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            SectionProperties sectionProperties1 = new SectionProperties(){ RsidR = "00185682" };
			...
			var row = new FamilyRow();
			foreach (var f in q)
				body1.Append(row.GenerateParagraph(f));
        ...
        private void GenerateStylesWithEffectsPart1Content(StylesWithEffectsPart stylesWithEffectsPart1)
        {
            ...
            Style style5 = new Style(){ Type = StyleValues.Character, StyleId = "apple-converted-space", CustomStyle = true };
            StyleName styleName5 = new StyleName(){ Val = "apple-converted-space" };
            BasedOn basedOn1 = new BasedOn(){ Val = "DefaultParagraphFont" };
            Rsid rsid1 = new Rsid(){ Val = "00A1337C" };

            style5.Append(styleName5);
            style5.Append(basedOn1);
            style5.Append(rsid1);

            Style style6 = new Style(){ Type = StyleValues.Paragraph, StyleId = "NoSpacing" };
            StyleName styleName6 = new StyleName(){ Val = "No Spacing" };
            UIPriority uIPriority4 = new UIPriority(){ Val = 1 };
            PrimaryStyle primaryStyle2 = new PrimaryStyle();
            Rsid rsid2 = new Rsid(){ Val = "0028497E" };
            ...
            Style style7 = new Style(){ Type = StyleValues.Paragraph, StyleId = "maincopy", CustomStyle = true };
            StyleName styleName7 = new StyleName(){ Val = "maincopy" };
            BasedOn basedOn2 = new BasedOn(){ Val = "Normal" };
            Rsid rsid3 = new Rsid(){ Val = "00734DD4" };

            StyleParagraphProperties styleParagraphProperties2 = new StyleParagraphProperties();
            SpacingBetweenLines spacingBetweenLines3 = new SpacingBetweenLines(){ Before = "100", BeforeAutoSpacing = true, After = "100", AfterAutoSpacing = true, Line = "240", LineRule = LineSpacingRuleValues.Auto };
            ...
            Style style8 = new Style(){ Type = StyleValues.Character, StyleId = "grame", CustomStyle = true };
            StyleName styleName8 = new StyleName(){ Val = "grame" };
            BasedOn basedOn3 = new BasedOn(){ Val = "DefaultParagraphFont" };
            Rsid rsid4 = new Rsid(){ Val = "00734DD4" };

            style8.Append(styleName8);
            style8.Append(basedOn3);
            style8.Append(rsid4);

            Style style9 = new Style(){ Type = StyleValues.Character, StyleId = "aawordstotypein", CustomStyle = true };
            StyleName styleName9 = new StyleName(){ Val = "aawordstotypein" };
            BasedOn basedOn4 = new BasedOn(){ Val = "DefaultParagraphFont" };
            Rsid rsid5 = new Rsid(){ Val = "00734DD4" };

            style9.Append(styleName9);
            style9.Append(basedOn4);
            style9.Append(rsid5);

            Style style10 = new Style(){ Type = StyleValues.Character, StyleId = "IntenseEmphasis" };
            StyleName styleName10 = new StyleName(){ Val = "Intense Emphasis" };
            BasedOn basedOn5 = new BasedOn(){ Val = "DefaultParagraphFont" };
            UIPriority uIPriority5 = new UIPriority(){ Val = 21 };
            PrimaryStyle primaryStyle3 = new PrimaryStyle();
            Rsid rsid6 = new Rsid(){ Val = "006217A5" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            style14.Append(uIPriority8);
            style14.Append(semiHidden6);
            style14.Append(unhideWhenUsed6);

            Style style15 = new Style(){ Type = StyleValues.Character, StyleId = "apple-converted-space", CustomStyle = true };
            StyleName styleName15 = new StyleName(){ Val = "apple-converted-space" };
            BasedOn basedOn6 = new BasedOn(){ Val = "DefaultParagraphFont" };
            Rsid rsid7 = new Rsid(){ Val = "00A1337C" };

            style15.Append(styleName15);
            style15.Append(basedOn6);
            style15.Append(rsid7);

            Style style16 = new Style(){ Type = StyleValues.Paragraph, StyleId = "NoSpacing" };
            StyleName styleName16 = new StyleName(){ Val = "No Spacing" };
            UIPriority uIPriority9 = new UIPriority(){ Val = 1 };
            PrimaryStyle primaryStyle5 = new PrimaryStyle();
            Rsid rsid8 = new Rsid(){ Val = "0028497E" };
            ...
            style16.Append(uIPriority9);
            style16.Append(primaryStyle5);
            style16.Append(rsid8);
            style16.Append(styleParagraphProperties3);

            Style style17 = new Style(){ Type = StyleValues.Paragraph, StyleId = "maincopy", CustomStyle = true };
            StyleName styleName17 = new StyleName(){ Val = "maincopy" };
            BasedOn basedOn7 = new BasedOn(){ Val = "Normal" };
            Rsid rsid9 = new Rsid(){ Val = "00734DD4" };

            StyleParagraphProperties styleParagraphProperties4 = new StyleParagraphProperties();
            SpacingBetweenLines spacingBetweenLines6 = new SpacingBetweenLines(){ Before = "100", BeforeAutoSpacing = true, After = "100", AfterAutoSpacing = true, Line = "240", LineRule = LineSpacingRuleValues.Auto };
            ...
            style17.Append(styleRunProperties3);

            Style style18 = new Style(){ Type = StyleValues.Character, StyleId = "grame", CustomStyle = true };
            StyleName styleName18 = new StyleName(){ Val = "grame" };
            BasedOn basedOn8 = new BasedOn(){ Val = "DefaultParagraphFont" };
            Rsid rsid10 = new Rsid(){ Val = "00734DD4" };

            style18.Append(styleName18);
            style18.Append(basedOn8);
            style18.Append(rsid10);

            Style style19 = new Style(){ Type = StyleValues.Character, StyleId = "aawordstotypein", CustomStyle = true };
            StyleName styleName19 = new StyleName(){ Val = "aawordstotypein" };
            BasedOn basedOn9 = new BasedOn(){ Val = "DefaultParagraphFont" };
            Rsid rsid11 = new Rsid(){ Val = "00734DD4" };

            style19.Append(styleName19);
            style19.Append(basedOn9);
            style19.Append(rsid11);

            Style style20 = new Style(){ Type = StyleValues.Character, StyleId = "IntenseEmphasis" };
            StyleName styleName20 = new StyleName(){ Val = "Intense Emphasis" };
            BasedOn basedOn10 = new BasedOn(){ Val = "DefaultParagraphFont" };
            UIPriority uIPriority10 = new UIPriority(){ Val = 21 };
            PrimaryStyle primaryStyle6 = new PrimaryStyle();
            Rsid rsid12 = new Rsid(){ Val = "006217A5" };
            ...
            styleRunProperties4.Append(italicComplexScript3);
            styleRunProperties4.Append(color3);

            style20.Append(styleName20);
            style20.Append(basedOn10);
            style20.Append(uIPriority10);
        ...
        {
            Ds.DataStoreItem dataStoreItem1 = new Ds.DataStoreItem(){ ItemId = "{E0559BA5-AE33-452D-AB3B-E5254B956AF4}" };
        ...
        private void GenerateWebSettingsPart1Content(WebSettingsPart webSettingsPart1)
        {
            ...
            Div div1 = new Div(){ Id = "1949506703" };
