...
namespace UtilityExtensions
{
    public static partial class Util
    {
        ...
        /// Add version of SendMsg to add CC addresses...
        /// 

        public static void SendMsgCC(string SysFromEmail, string CmsHost, MailAddress From, string subject, string Message, List<MailAddress> to, List<MailAddress> cc, int id, int? pid, List<LinkedResource> attachments = null)
        {
