...
[LeaderId] [int] NULL,
[LeaderName] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ClassFilled] [bit] NULL,
[OnLineCatalogSort] [int] NULL,
[PendingLoc] [nvarchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[ValidateOrgs] [nvarchar] (60) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[PhoneNumber] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[RegistrationClosed] [bit] NULL,
[AllowKioskRegister] [bit] NULL,
[WorshipGroupCodes] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[lat] [float] NULL,
[long] [float] NULL,
[RegSetting] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[OrgPickList] [varchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Offsite] [bit] NULL,
[RegStart] [datetime] NULL,
[RegEnd] [datetime] NULL,
[LimitToRole] [nvarchar] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[OrganizationTypeId] [int] NULL,
[MemberJoinScript] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[AddToSmallGroupScript] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[RemoveFromSmallGroupScript] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[GiftNotifyIds] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[VisitorDate] AS (CONVERT([datetime],dateadd(day,-(7)*isnull([RollSheetVisitorWks],(3)),CONVERT([date],getdate(),(0))),(0))),
[UseBootstrap] [bit] NULL,
[PublicSortOrder] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UseRegisterLink2] [bit] NULL,
[AppCategory] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[RegistrationTitle] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
