...
[Message] [nvarchar] (160) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_SMSList1_slMessage] DEFAULT (''),
...
[Title] [nvarchar] (150) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_SMSList_Title] DEFAULT ('')
)
GO
